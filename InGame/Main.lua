...
Tabs.Main:AddDropdown("Grab", {Title = "Pickup Item",Values = {"EMF Reader","Spirit Box", "Ghost Goggles", "Book", "Motion Sensor", "Crucifix", "Camera", "Flashlight", "Thermometer"},Multi = false,Default = nil,})
Tabs.Main:AddToggle("breakghost", {Title = "Break Ghost Hunting (Godmode)", Default = false })
...
Tabs.Main:AddToggle("spamchat", {Title = "Spam Chat", Default = false })
...
Tabs.World:AddToggle("paths", {Title = "Show Paths", Default = false })

Tabs.Evidence:AddSection("Detect Evidence")

Tabs.Evidence:AddToggle("EMF", {Title = "Auto Detect EMF 5", Default = false })
Tabs.Evidence:AddToggle("Writing", {Title = "Auto Detect Ghost Writing", Default = false })
Tabs.Evidence:AddToggle("Orbs", {Title = "Auto Detect Ghost Orbs", Default = false })
Tabs.Evidence:AddToggle("Fingerprints", {Title = "Auto Detect Fingerprints", Default = false })
Tabs.Evidence:AddToggle("SpiritBox", {Title = "Force Spirit Box \n Normal Spirit Box restrictions apply", Default = false })
...
Tabs.Visuals:AddToggle("Players", {Title = "Players ESP", Default = false })
Tabs.Visuals:AddToggle("Body", {Title = "Dead Bodies ESP", Default = false })
Tabs.Visuals:AddToggle("Items", {Title = "Items ESP", Default = false })
Tabs.Visuals:AddToggle("Closets", {Title = "Closets ESP", Default = false })
Tabs.Visuals:AddToggle("Van", {Title = "Van ESP", Default = false })
Tabs.Visuals:AddToggle("Interactables", {Title = "Interactables ESP", Default = false })

Tabs.Settings:AddSection("Script Customizations")

Tabs.Settings:AddToggle("auto", {Title = "Auto Check Evidence in Journal when Detected", Default = true })
Tabs.Settings:AddToggle("objecttp", {Title = "Use Teleports For Lights/Doors", Default = false })
Tabs.Settings:AddToggle("locator", {Title = "FE Ghost Locator", Default = false })
Tabs.Settings:AddToggle("ghostnotifs", {Title = "Ghost Hunting Notification", Default = false })
